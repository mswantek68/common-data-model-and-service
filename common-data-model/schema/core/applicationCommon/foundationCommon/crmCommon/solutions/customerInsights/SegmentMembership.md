---
title: SegmentMembership - Common Data Model | Microsoft Docs
...
Members participating in a given segment.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/solutions/customerInsights/SegmentMembership.cdm.json" target="_blank">GitHub</a>.  

## Instances

Instances of this entity are listed below.  

- /foundationCommon/crmCommon/solutions/customerInsights/SegmentMembership  

## Attributes

|Name|Description|First Included in Instance|
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="SegmentMembership.md" target="_blank">customerInsights/SegmentMembership</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="SegmentMembership.md" target="_blank">customerInsights/SegmentMembership</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="SegmentMembership.md" target="_blank">customerInsights/SegmentMembership</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="SegmentMembership.md" target="_blank">customerInsights/SegmentMembership</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="SegmentMembership.md" target="_blank">customerInsights/SegmentMembership</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="SegmentMembership.md" target="_blank">customerInsights/SegmentMembership</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="SegmentMembership.md" target="_blank">customerInsights/SegmentMembership</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="SegmentMembership.md" target="_blank">customerInsights/SegmentMembership</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="SegmentMembership.md" target="_blank">customerInsights/SegmentMembership</a>|
|[ownerId](#ownerId)|Owner Id|<a href="SegmentMembership.md" target="_blank">customerInsights/SegmentMembership</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="SegmentMembership.md" target="_blank">customerInsights/SegmentMembership</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="SegmentMembership.md" target="_blank">customerInsights/SegmentMembership</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="SegmentMembership.md" target="_blank">customerInsights/SegmentMembership</a>|
...
|[stateCode_display](#stateCode_display)||<a href="SegmentMembership.md" target="_blank">customerInsights/SegmentMembership</a>|
|[statusCode](#statusCode)|Reason for the status of the Segment Membership|<a href="SegmentMembership.md" target="_blank">customerInsights/SegmentMembership</a>|
|[statusCode_display](#statusCode_display)||<a href="SegmentMembership.md" target="_blank">customerInsights/SegmentMembership</a>|
...
Latest date when a segment memberships is evaluated/refreshed.  
First included in: customerInsights/SegmentMembership (this entity)  
...
Required name field to be used as the primary name for the customer segment membership.  
First included in: customerInsights/SegmentMembership (this entity)  
...
Denotes latest version of the customer segment membership for manual tracking.  
First included in: customerInsights/SegmentMembership (this entity)  
...
Status of the Segment Membership  
First included in: customerInsights/SegmentMembership (this entity)  
...
Reason for the status of the Segment Membership  
First included in: customerInsights/SegmentMembership (this entity)  
